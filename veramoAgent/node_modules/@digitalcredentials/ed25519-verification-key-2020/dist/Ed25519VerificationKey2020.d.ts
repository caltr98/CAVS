 ...
 */
import { GenerateKeyPairOptions, KeyPair, PublicKeyJwk, PrivateKeyJwk, SerializedKeyPair, Signer, VerificationResult, Verifier } from '@digitalcredentials/keypair';
export declare class Ed25519VerificationKey2020 extends KeyPair {
     ...
     */
    static from(options: SerializedKeyPair): Promise<Ed25519VerificationKey2020>;
    /**
     ...
     */
    static fromJsonWebKey2020({ id, type, controller, publicKeyJwk, privateKeyJwk }: SerializedKeyPair): Promise<Ed25519VerificationKey2020>;
    /**
     ...
     */
    static generate({ seed, ...keyPairOptions }?: GenerateKeyPairOptions): Promise<Ed25519VerificationKey2020>;
    /**
     ...
     *   (to JSON, etc), for use in DIDs, Linked Data Proofs, etc.
     */
    toEd255519VerificationKey2018({ publicKey, privateKey, includeContext }?: {
        publicKey?: boolean;
        privateKey?: boolean;
        includeContext?: boolean;
    }): SerializedKeyPair;
     ...
     */
    toJsonWebKey2020(): Promise<SerializedKeyPair>;
    /**
