...
export class Ed25519VerificationKey2020 extends KeyPair {
    ...
    static async fromJsonWebKey2020({ id, type, controller, publicKeyJwk, privateKeyJwk }) {
        ...
        const publicKeyBytes = base64url.decode(publicKeyBase64Url);
        ...
        if (privateKeyJwk) {
            ...
            const privateKeyBytes = base64url.decode(privateKeyBase64Url);
    ...
    toJwk({ publicKey = true, privateKey = false } = {}) {
        ...
        if (privateKey && this._privateKeyBuffer) {
            ...
            jwk.d = base64url.encode(this._privateKeyBuffer.slice(0, this._privateKeyBuffer.length - this._publicKeyBuffer.length));
        }
        return jwk;
    }
    /**
