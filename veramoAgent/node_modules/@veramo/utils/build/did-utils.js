 ...
 * @beta This API may change without a BREAKING CHANGE notice.
 */
export function getChainId(verificationMethod) {
    let result;
    if (verificationMethod.blockchainAccountId?.includes('@eip155')) {
 ...
 * @beta This API may change without a BREAKING CHANGE notice.
 */
export async function mapIdentifierKeysToDoc(identifier, section = 'keyAgreement', context, resolutionOptions) {
 ...
 * @beta This API may change without a BREAKING CHANGE notice.
 */
export async function resolveDidOrThrow(didUrl, context, resolutionOptions) {
    // TODO: add caching
