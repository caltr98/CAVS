...
export class LdCredentialModule {
    ...
    getDocumentLoader(context, options) {
    ...
    async verifyCredential(credential, options, context) {
    ...
    async verifyPresentation(presentation, challenge, domain, options, context) {
        const fetchRemoteContexts = options.fetchRemoteContexts ?? false;
