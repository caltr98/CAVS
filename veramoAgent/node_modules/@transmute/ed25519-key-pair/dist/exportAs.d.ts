...
export declare const toX25519KeyAgreementKey2019: (id: string, controller: string, publicKey: Uint8Array, privateKey?: Uint8Array | undefined) => Ed25519VerificationKey2018;
export declare const exportableTypes: {
    ...
    Ed25519VerificationKey2018: (id: string, controller: string, publicKey: Uint8Array, privateKey?: Uint8Array | undefined) => Ed25519VerificationKey2018;
};
