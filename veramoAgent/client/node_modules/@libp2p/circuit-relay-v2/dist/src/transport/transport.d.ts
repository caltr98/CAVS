...
import type { Transport, CreateListenerOptions, Listener, Connection, Stream, PeerId, OutboundConnectionUpgradeEvents, DialOptions } from '@libp2p/interface';
import type { IncomingStreamData, OpenConnectionProgressEvents } from '@libp2p/interface-internal';
...
export declare class CircuitRelayTransport implements Transport<CircuitRelayDialEvents> {
     ...
     */
    dial(ma: Multiaddr, options: DialOptions<CircuitRelayDialEvents>): Promise<Connection>;
