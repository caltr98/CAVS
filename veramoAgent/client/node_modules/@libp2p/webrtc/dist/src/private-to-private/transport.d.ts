...
import type { OutboundConnectionUpgradeEvents, CreateListenerOptions, DialOptions, Transport, Listener, Upgrader, ComponentLogger, Connection, PeerId, CounterGroup, Metrics, Startable } from '@libp2p/interface';
...
export declare class WebRTCTransport implements Transport<WebRTCDialEvents>, Startable {
    ...
    dial(ma: Multiaddr, options: DialOptions<WebRTCDialEvents>): Promise<Connection>;
