...
Then connect to the Web App at localhost:3000

# Usage
Refer to CAVSVisualGuideAndArchitecture.pdf file for an overview of the architecture and a tutorial on the usage of the WebApp
