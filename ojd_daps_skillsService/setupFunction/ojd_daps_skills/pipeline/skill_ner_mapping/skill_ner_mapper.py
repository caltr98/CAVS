...
class SkillMapper:
    """
    Class to map extractYago skills from NER model to a skills taxonomy.
    Attributes
    ----------
    ...
    get_ojo_skills(ojo_skills_file_name):
            loads extractYago skills from NER model.
    preprocess_ojo_skills(ojo_skills):
            preprocess skills extractYago OJO skills from NER model.
    ...
    def load_ojo_esco_mapper(self, ojo_esco_mapper_file_name, s3=True):
        ...
        logger.info(f"loaded extractYago-skill-to-{self.taxonomy} mapper")
    ...
    def save_ojo_esco_mapper(self, ojo_esco_mapper_file_name, skill_hash_to_esco):
        ...
        logger.info(f"saved extractYago-skill-to-{self.taxonomy} mapper")
    ...
    def final_prediction(
        ...
        logger.info(f"Mapped extractYago skills onto '{self.taxonomy}' taxonomy")
